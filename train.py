from kernels import cell
import argparse

parser = argparse.ArgumentParser()
# parser.add_argument('model_prefix', type=str, help='model name prefix')
parser.add_argument('model_prefix', type=str, help='model name prefix')
# parser.add_argument("-p", "--model_prefix", help="model file path prefix", required=True)
...
parser.add_argument("-bz", "--batch_size", type=int, default=256, help="size of the batches")
...
parser.add_argument("-ld", "--latent_dim", type=int, default=512, help="dimensionality of the latent space")
parser.add_argument("-iz", "--image_size", type=int, default=56, help="input image size")
parser.add_argument('-md','--model', type=str, default="vit", help="model: ae/vae/vqvae/resnet18/resnet34/resnet50/resnet101/resnet152/vgg11/vgg13/vgg16/vgg19/vit/vit_tiny/simplevit/mlpmixer/convmixer/cait/swin_t/swin_s/swin_b/swin_l")
...
parser.add_argument("-wxc", "--cell_correlation_weight", type=float, default=1000000, help="correlation weight")
parser.add_argument("-wxg", "--gene_correlation_weight", type=float, default=1000000, help="correlation weight")
